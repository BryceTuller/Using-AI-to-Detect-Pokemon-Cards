...
# Initial thresholds for optimization
best_color_threshold = 0.62
best_edge_threshold = 550
best_precision = 0
best_recall = 0
best_f1 = 0
best_accuracy = 0
...
# Testing fine-grained range around the current best thresholds
color_thresholds = [0.62]
edge_thresholds = range(550, 600, 5)
...
for color_threshold in color_thresholds:
    for edge_threshold in edge_thresholds:
        ...
        # Update best metrics if precision is high and F1 score is better
